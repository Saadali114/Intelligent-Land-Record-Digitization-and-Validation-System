      ...
      <div className="space-y-6">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-5 shadow-sm flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div>
            <div className="flex items-center gap-2 mb-1">
              ...
              <span className="text-xs text-slate-400">Section 149 MLRC</span>
            </div>
            <h1 className="text-2xl font-bold text-white">Land Document Verifications</h1>
            <p className="text-sm text-slate-400 mt-1">
              Track the progress of your digitized land titles, AI validation metrics, and Sub-Divisional Officer decisions.
            </p>
          </div>
          <Link
          ...
          <div className="bg-amber-950/40 border border-amber-500/40 rounded-xl p-4 flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-amber-200/80 mt-0.5">
                The Revenue Officer has requested additional documentation or clarification for{' '}
                {pendingClarifications.length} application(s). Please review and submit your reply promptly.
              </p>
            </div>
            <Link
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 flex items-center justify-between gap-4">
          <div className="relative flex-1">
            ...
            <input
              type="text"
              placeholder="Search by Tracking ID, Document Type, or Survey Number..."
              value={searchQuery}
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-xl overflow-hidden shadow-sm">
          {loading ? (
            ...
            <div className="py-16 text-center text-slate-400">
              ...
              <p className="text-sm font-medium text-slate-300">No verification applications found</p>
              <p className="text-xs text-slate-500 mt-1">Upload a land document to initiate automated verification.</p>
              <Link
                href="/citizen/documents/upload"
              ...
              <table className="w-full text-left text-sm text-slate-300">
                <thead className="bg-slate-950/60 border-b border-slate-800 text-xs font-semibold text-slate-400 uppercase tracking-wider">
                  <tr>
                    ...
                    <th className="px-5 py-3">Survey & Village</th>
                    <th className="px-5 py-3">AI Integrity Check</th>
                    <th className="px-5 py-3">Officer Status</th>
                      ...
                      <tr key={appId} className="hover:bg-slate-800/40 transition-colors">
                        ...
                        <td className="px-5 py-4">
                          ...
                          >
                            ...
                            {item.riskAssessment?.level || 'LOW'} Risk ({item.riskAssessment?.score ?? 15}/100)
                          </span>
                        </td>
                        ...
                        <td className="px-5 py-4 text-right">
                          ...
                          >
                            {isClarification ? 'Respond' : 'View Status'}
