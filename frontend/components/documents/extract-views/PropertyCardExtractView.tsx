      ...
      <div className="p-3 bg-purple-50/70 rounded-lg border border-purple-100 flex items-start justify-between">
        <div>
          <div className="text-[10px] text-purple-800 uppercase font-semibold">
            {t('documents.ctsNumberHeader', {
              defaultValue: 'नगर भूमापन क्रमांक (City Survey / CTS No.)',
            })}
          </div>
        ...
        <div className="text-right">
          <div className="text-[10px] text-purple-800 uppercase font-semibold">
            {t('documents.sheetWardNoHeader', {
              defaultValue: 'शिट व प्रभाग क्रमांक (Sheet & Ward No.)',
            })}
          </div>
      ...
      <div className="grid grid-cols-2 gap-2 text-xs">
        <div className="p-2.5 rounded-lg bg-slate-50 border border-slate-200">
          <span className="text-[10px] text-slate-500 font-medium">
            {t('documents.propertyHolder', {
              defaultValue: 'नोंदणीकृत मिळकतधारक (Property Holder)',
            })}:
          </span>
        ...
        <div className="p-2.5 rounded-lg bg-slate-50 border border-slate-200">
          <span className="text-[10px] text-slate-500 font-medium">
            {t('documents.carpetPlotArea', {
              defaultValue: 'चटई / भूखंड क्षेत्र (Carpet / Plot Area)',
            })}:
          </span>
        ...
        <div className="p-2.5 rounded-lg bg-slate-50 border border-slate-200">
          <span className="text-[10px] text-slate-500 font-medium">
            {t('documents.localBodyJurisdiction', {
              defaultValue: 'स्थानिक स्वराज्य संस्था (Local Body Jurisdiction)',
            })}:
          </span>
        ...
        <div className="p-2.5 rounded-lg bg-slate-50 border border-slate-200">
          <span className="text-[10px] text-slate-500 font-medium">
            {t('documents.districtLabel', { defaultValue: 'जिल्हा (District)' })}:
          </span>
          <div className="mt-0.5 font-semibold text-slate-800">
        ...
        <div className="p-2.5 rounded-lg bg-slate-50 border border-slate-200">
          <span className="text-[10px] text-slate-500 font-medium">
            {t('documents.propertyClassification', {
              defaultValue: 'मिळकत वर्ग (Property Classification)',
            })}:
          </span>
          <div className="mt-0.5 font-semibold text-slate-800">
        ...
        <div className="p-2.5 rounded-lg bg-slate-50 border border-slate-200">
          <span className="text-[10px] text-slate-500 font-medium">
            {t('documents.tenureType', { defaultValue: 'धारणा पद्धती (Tenure Type)' })}:
          </span>
          <div className="mt-0.5 font-semibold text-slate-800">
        ...
        <div className="p-2.5 rounded-lg bg-slate-50 border border-slate-200">
          <span className="text-[10px] text-slate-500 font-medium">
            {t('documents.encumbranceStatus', {
              defaultValue: 'बोजा व न्यायाधीन नोंदी (Encumbrance Status)',
            })}:
          </span>
        ...
        <div className="p-2.5 rounded-lg bg-slate-50 border border-slate-200">
          <span className="text-[10px] text-slate-500 font-medium">
            {t('documents.recordValidationStatus', {
              defaultValue: 'अभिलेख स्थिती (Validation Status)',
            })}:
          </span>
          <div className="mt-0.5 font-semibold text-emerald-700 flex items-center gap-1">
            <Check className="w-3.5 h-3.5" />{' '}
            {t('documents.certifiedDigitalCopy', {
              defaultValue: 'प्रमाणित डिजिटल प्रत (Verified)',
            })}
          </div>
        </div>
      </div>
